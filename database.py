    ...
    try:
        with conn.cursor() as cur:
            cur.execute("""
                ...
                -- Migração idempotente para bancos criados por versões anteriores.
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS token_recuperacao TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS idade INTEGER;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS gosto_jogos TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS telefone TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS steam_id64 TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS steam_api_key TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS steam_library_path TEXT;
                ...
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS hydra_library_path TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS hydra_account_email TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS hydra_usuario TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS hydra_pin TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS hydra_token TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS hydra_current_game TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS hydra_last_update TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS library_style TEXT NOT NULL DEFAULT 'classic';
                ...
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS foto_perfil TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS data_cadastro TEXT;
                ALTER TABLE gameunexa_usuarios ADD COLUMN IF NOT EXISTS is_admin BOOLEAN NOT NULL DEFAULT FALSE;
